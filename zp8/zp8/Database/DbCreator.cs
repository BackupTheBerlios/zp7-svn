...
namespace Generated
{
    public static class DbCreator
    {
        ...
        private static void UpdateToVersion_1(DbConnection conn, DbTransaction tran)
        {
            ...
            ExecuteNonQuery(conn, tran, "ALTER TABLE \"song\" RENAME TO \"temp_table_3_129075462762230000\"");
            ...
            ExecuteNonQuery(conn, tran, "INSERT INTO \"song\" (\"ID\", \"title\", \"groupname\", \"author\", \"lang\", \"server_id\", \"netID\", \"transp\", \"published\", \"localmodified\", \"remark\") select \"ID\" AS \"ID\", \"title\" AS \"title\", \"groupname\" AS \"groupname\", \"author\" AS \"author\", \"lang\" AS \"lang\", \"server_id\" AS \"server_id\", \"netID\" AS \"netID\", \"transp\" AS \"transp\", \"published\" AS \"published\", \"localmodified\" AS \"localmodified\", \"remark\" AS \"remark\" FROM \"temp_table_3_129075462762230000\"");
            ExecuteNonQuery(conn, tran, "DROP TABLE \"temp_table_3_129075462762230000\"");
            ExecuteNonQuery(conn, tran, "ALTER TABLE \"server\" RENAME TO \"temp_table_4_129075462762320000\"");
            ExecuteNonQuery(conn, tran, "CREATE TABLE \"server\" ( \n    \"ID\" integer primary key NOT NULL, \n    \"url\" text NULL, \n    \"servertype\" text NULL, \n    \"config\" text NULL, \n    \"isreadonly\" logical NULL\n)");
            ExecuteNonQuery(conn, tran, "INSERT INTO \"server\" (\"ID\", \"url\", \"servertype\", \"config\", \"isreadonly\") select \"ID\" AS \"ID\", \"url\" AS \"url\", \"servertype\" AS \"servertype\", \"config\" AS \"config\", \"isreadonly\" AS \"isreadonly\" FROM \"temp_table_4_129075462762320000\"");
            ExecuteNonQuery(conn, tran, "DROP TABLE \"temp_table_4_129075462762320000\"");
            ExecuteNonQuery(conn, tran, "ALTER TABLE \"deletedsong\" RENAME TO \"temp_table_5_129075462762350000\"");
            ExecuteNonQuery(conn, tran, "CREATE TABLE \"deletedsong\" ( \n    \"ID\" integer primary key NOT NULL, \n    \"song_netID\" integer NULL, \n    \"server_id\" integer NULL, \n    CONSTRAINT \"FK_deletedsong_server_id\" FOREIGN KEY (\"server_id\") REFERENCES \"server\"(\"ID\")\n)");
            ExecuteNonQuery(conn, tran, "INSERT INTO \"deletedsong\" (\"ID\", \"song_netID\", \"server_id\") select \"ID\" AS \"ID\", \"song_netID\" AS \"song_netID\", \"server_id\" AS \"server_id\" FROM \"temp_table_5_129075462762350000\"");
            ExecuteNonQuery(conn, tran, "DROP TABLE \"temp_table_5_129075462762350000\"");
        ...
        {
            ExecuteNonQuery(conn, tran, "ALTER TABLE \"server\" RENAME TO \"temp_table_6_129075462763420000\"");
            ExecuteNonQuery(conn, tran, "CREATE TABLE \"server\" ( \n    \"ID\" integer primary key NOT NULL, \n    \"url\" text NULL, \n    \"servertype\" text NULL, \n    \"config\" text NULL, \n    \"isreadonly\" logical NULL, \n    \"serverlist_id\" integer NULL, \n    CONSTRAINT \"FK_server_serverlist_id\" FOREIGN KEY (\"serverlist_id\") REFERENCES \"serverlist\"(\"ID\")\n)");
            ExecuteNonQuery(conn, tran, "INSERT INTO \"server\" (\"ID\", \"url\", \"servertype\", \"config\", \"isreadonly\") select \"ID\" AS \"ID\", \"url\" AS \"url\", \"servertype\" AS \"servertype\", \"config\" AS \"config\", \"isreadonly\" AS \"isreadonly\" FROM \"temp_table_6_129075462763420000\"");
            ExecuteNonQuery(conn, tran, "DROP TABLE \"temp_table_6_129075462763420000\"");
